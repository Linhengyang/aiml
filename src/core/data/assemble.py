...
def chunk_seq_to_batch_pow2(data: t.Dict[int, torch.Tensor], tgt_L: int, min_L: int, pad_value: int = 0):
    '''
...
def chunk_seq_to_batch_slide(seq: torch.Tensor, tgt_L: int, overlap: int = 0, pad_value: int = 0):
    '''
