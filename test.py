...
import torch
from Config import base_data_dpath, seq2seq_dname, eng2fra_fname, eng2fra_test_fname
...
if __name__ == "__main__":
    ...
    init_iter, _, _ = data_loader_seq2seq(path=eng2fra_test, batch_size=2, num_steps=8)
    ...
    trainer = transformerTrainer(net, None, train_iter, 3, None, 
                                 None, None, init_iter)
    # trainer.topo_logger('lazy_topo.txt')
    trainer.net_resolver()
    trainer.param_initializer()
