...
from Code.projs.cfrec.Dataset import MovieLensDataset
if __name__ == "__main__":
    ...
    trainset = MovieLensDataset(path, False, split_method='random')
    train_iter = torch.utils.data.DataLoader(trainset, batch_size = 3, shuffle = False)
    for u, i, s in train_iter:
        print('users: ', u)
        print('items: ', i)
        print('scores: ', s)
        break
